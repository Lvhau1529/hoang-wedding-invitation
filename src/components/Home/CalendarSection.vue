<template>
  <section class="calendar">
    <div class="px-8 py-14">
      <h3 class="month text-4xl font-signature text-center text-white mb-6">Tháng 12</h3>
...
<script setup lang="ts">
  ...
  const calendarCells = computed<Cell[]>(() => buildMonthCells(2025, 11, guest === 'groom' ? 7 : 7))
