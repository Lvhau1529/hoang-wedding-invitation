...
<script setup lang="ts">
  ...
  const dataLocation: Record<string, DataLocation> = {
    groom: {
      ...
      restaurant: 'Tư gia nhà trai',
      address: 'Nhà số 3, đường Đặng Công Chất, Yên Viên, Gia Lâm, Hà Nội',
      map: 'https://maps.app.goo.gl/7764obog9yTpWmvi9'
    },
    bride: {
      ...
      year: 'Năm 2025',
      date: '18 tháng 10 năm Ất Tỵ',
      restaurant: 'Công ty THHH Thanh Chuyên',
      address: 'Mỏ Chè, Sông Công, Thái Nguyên',
      map: 'https://maps.app.goo.gl/137xmwEtweQNWYyM7'
    }
  }
